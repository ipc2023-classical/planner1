...
HEURISTICS_MAP = {
    "lazy_wastar-hmax-w2":
    ["--action-elimination-planner-config", "--search", "lazy_wastar([hmax()], w=2)"],
    "lazy_wastar-hmax-w3":
    ["--action-elimination-planner-config", "--search", "lazy_wastar([hmax()], w=3)"],
    # "lama-first":
    # ["--action-elimination-planner-config", "--evaluator",
